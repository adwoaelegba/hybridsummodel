...
### 2. Enhanced Extractive Summarization
...
### 3. Abstractive Summarization (PEGASUS)
...
### 4. GPT-Based Refinement (Optional)
...
Section-wise Processing
   ↓
TF-IDF + Semantic Extractive Ranking
   ↓
...
TPU support is optionally available via `torch_xla`.

---

## Design Philosophy

Koios is built around three principles:

### Accuracy

Legal keywords and phrases are explicitly boosted to preserve compliance-relevant information.

### Readability

Abstractive modeling and optional GPT refinement make summaries accessible to non-legal audiences.

### Modularity

Each component (extraction, extractive ranking, abstractive summarization, refinement, evaluation) can be used independently.

---

## Limitations

* PEGASUS input is limited to 1024 tokens.
* Extractive selection depends on predefined privacy keywords.
* GPT refinement requires an OpenAI API key.
* Summarization quality may vary depending on document structure.
* Legal nuance may still require human validation.
